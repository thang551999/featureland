      ...
      <div className="footer__content">
        <Row className="footer__content__links" justify="space-around">
          ...
          <Col
            ...
            lg={17}
            xl={13}
            className="footer__content__links__pages"
          >
            {pages.map((item, index) => (
              <Link
                key={index}
                href={item.href}
                className={classNames('footer__content__links__pages__text', {
          ...
          <Col
            ...
            lg={3}
            xl={3}
            className="footer__content__links__social-apps"
          >
            {socialApps.map((item, index) => (
              <Link key={index} href={item.href}>
                <Image
                  wrapperClassName="footer__content__links__social-apps__app"
                  src={item.icon}
                  width={20}
                  height={20}
                  alt={item.alt}
        ...
        <Row className="footer__content__license" align="middle">
          © 2023 DREAM LAND. All Rights Reserved.
        </Row>
      </div>
    </div>
  );
